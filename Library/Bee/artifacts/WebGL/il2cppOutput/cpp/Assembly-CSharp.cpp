...
IL2CPP_EXTERN_C String_t* _stringLiteral6F156DF233988F9DD6FE3B61135F813069C9FD87;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void DetachOnceVisible_Update_m85B3A6FC1314EA0A71F706FA5F289884A749A68F (DetachOnceVisible_t1852D1C8DC92EEE2A21CF304338F8F2DC0C21AFF* __this, const RuntimeMethod* method) 
{
	...
	if (!s_Il2CppMethodInitialized)
	{
		...
		il2cpp_codegen_initialize_runtime_metadata((uintptr_t*)&_stringLiteral6F156DF233988F9DD6FE3B61135F813069C9FD87);
...
IL_001d:
	{
		...
		V_1 = L_6;
		String_t* L_7;
		L_7 = Matrix4x4_ToString_mB310BE20B7CDE8AEA91D84FCA4E75BCACF7DFC86((&V_1), NULL);
		String_t* L_8;
		L_8 = String_Concat_m9E3155FB84015C823606188F53B47CB44C444991(_stringLiteral6F156DF233988F9DD6FE3B61135F813069C9FD87, L_7, NULL);
		il2cpp_codegen_runtime_class_init_inline(Debug_t8394C7EEAECA3689C2C9B9DE9C7166D73596276F_il2cpp_TypeInfo_var);
		Debug_Log_m87A9A3C761FF5C43ED8A53B16190A53D08F818BB(L_8, NULL);
		// if (!hasDetached && pose != Matrix4x4.identity)
		bool L_9 = __this->___hasDetached_6;
		if (L_9)
		{
			goto IL_0086;
		}
	}
	{
		...
		bool L_12;
		L_12 = Matrix4x4_op_Inequality_m318CC0235679529F15B2C56E0896E70A2BD62713_inline(L_10, L_11, NULL);
		if (!L_12)
		{
			goto IL_0086;
		}
	}
	{
		...
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_13 = __this->___trackedContent_5;
